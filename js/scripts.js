$(document).ready(function () {
    ...
    for (var i = 0; i < share_bar.length; i++) {
        var html = '<iframe allowtransparency="true" frameborder="0" scrolling="no"' +
            'src="https://platform.twitter.com/widgets/tweet_button.html?url=' + encodeURIComponent(window.location) + '&amp;text=' + encodeURIComponent(document.title) + '&amp;via=willandsharonweddingsite&amp;hashtags=willandsharonwedding&amp;count=horizontal"' +
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Will and Sharon's Wedding",

            // Event start date
            start: new Date('Oct 12, 2019 15:00'),
            ...
            end: new Date('Oct 12, 2019 20:00'),

            // Event Address
            address: 'Jamison Brown House, Santa Clara, CA',
